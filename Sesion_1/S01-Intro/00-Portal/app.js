///// ESTUDIANTES AQUÍ
    const PORTAL_SIZE = 4; //Dato númerico
    const PORTAL_SPEED = 5;
    var portalColor = "#ff6633"; //Comillas:texto
    var portalPatterns = [
        './assets/tiles/Craters/Craters 13 - 512x512.png', //texto
        './assets/tiles/Milky/Milky 12 - 512x512.png',//texto
        './assets/tiles/Streak/Streak 4 - 512x512.png',//texto
        './assets/tiles/Swirl/Swirl 1 - 512x512.png',//texto
