...
window.addEventListener('click', (event) => {
    ...
    if (dentroDeCanvas) {
        ...
        if (hit.length > 0) {
            ...
            // Rotar 720° (2 vueltas) alrededor del eje Y al hacer click
            gsap.to(objeto.rotation, { y: objeto.rotation.y + Math.PI * 4, duration: 1.2, ease: 'power2.inOut', overwrite: 'auto' });
        }
    } else {
